    ...
    public String validarFecha() {
        ...
        while (!fecha_valida) {
            ...
            if (fecha.length() == 8) {
                ...
                System.out.println(formato_dd + "  " + mm + "   " + yyyy); // provisional para hacer la prueba ya que no
                                                                           // me funciona

                if ((mm.equals("01") || mm.equals("03") || mm.equals("05") || mm.equals("07") || mm.equals("08")
                        || mm.equals("10") || mm.equals("12")) && (dia <= 31) && (año >= año_actual)) {
                    fecha_valida = true;
                } else if ((mm.equals("04") || mm.equals("06") || mm.equals("09") || mm.equals("11")) && (dia <= 30)
                        && (año >= año_actual)) {
                    fecha_valida = true;
